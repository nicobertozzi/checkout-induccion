...
public class ProcessPaymentRequestHandler implements  RequestHandler {
    ...
    public ProcessPaymentRequestHandler(Request request) {
    ...
    private void manualValidation() {
        ...
        if(StringUtils.isBlank(paymentDTO.getEmail())) {
            ...
            if(!EmailValidator.getInstance().isValid(paymentDTO.getEmail())) {
        ...
        if(StringUtils.isBlank(paymentDTO.getIssuerId())) {
            ...
            if(!StringUtils.isNumeric(paymentDTO.getIssuerId())) {
                this.invalidCauses.add(new ErrorCause(INVALID_ISSUER_ID_CODE, "Invalid payment processing. Issuer ID is not a valid number"));
            }
        }
        if(StringUtils.isBlank(paymentDTO.getPaymentMethodId())) {
            ...
            if(!StringUtils.isAlpha(paymentDTO.getPaymentMethodId())) {
